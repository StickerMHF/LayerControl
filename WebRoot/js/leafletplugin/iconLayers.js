...
//                	暂时
        ...
        setActiveLayer: function(layer) {
            ...
            if(l.type == "overlying"){
            	if(this.options.overlyingStatus == "none"){
            		panoramaGroup.addTo(map);
            		this.options.overlyingStatus = "block";
            	}else{
            		map.removeLayer(panoramaGroup);
            		this.options.overlyingStatus = "none";
            	}
