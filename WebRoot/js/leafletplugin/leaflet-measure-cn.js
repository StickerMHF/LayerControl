...
L.Control.Measure = L.Control.extend({
  ...
  _handleMeasureDoubleClick: function () {
    ...
    //测面修改样式
    $(".leaflet-zoom-animated").setAttribute("style","z-index:99999");
    $(".toolbar .measurePoly").setAttribute("value", "-1");
	$(".toolbar .measurePoly").setAttribute("src", "../../images/toolbar/gongju_cemian_noral.png");
  },
